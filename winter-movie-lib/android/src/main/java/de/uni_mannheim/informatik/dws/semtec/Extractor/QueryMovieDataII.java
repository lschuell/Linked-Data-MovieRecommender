...
public class QueryMovieDataII {
    ...
    public static void main(String[] args) {
        QueryMovieDataII qmd = new QueryMovieDataII();
    ...
    public void run() throws InterruptedException{
        ...
        Logger logger = LoggerFactory.getLogger(QueryMovieDataII.class.getName());
    ...
    class RunnableMovieDataFraction implements Runnable {
        ...
        public void writeAMovie(String URI, int n) throws QueryParseException, IOException {
            ...
            if (rs.hasNext()) {
                ...
                if(!values.isEmpty()){
                    try (
                            Writer writer = new FileWriter(new File("data/moviesI.csv"), true);
